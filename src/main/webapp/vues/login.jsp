...
<div class="container my-5">
    <div class="login-container">
        ...
        <div class="text-center mt-3">
            ...
            <br> 
            <!-- Lien vers la page d'inscription Freelancer -->
            <a href="<spring:url value='/inscription_freelancer' />" class="btn btn-info">Inscrivez-vous Freelancer</a>
            <!-- Lien vers la page d'inscription Client -->
            <a href="<spring:url value='/inscription_client' />" class="btn btn-warning">Inscrivez-vous Client</a>
            </p>
        </div>
    </div>
</div>
